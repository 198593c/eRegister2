			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="full_studentname" title="${message(code: 'student.full_studentname.label', default: 'Fullstudentname')}" />
				...
				<g:each in="${studentInstanceList}" status="i" var="studentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${studentInstance.id}">${fieldValue(bean: studentInstance, field: "full_studentname")}</g:link></td>
