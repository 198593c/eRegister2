	...
	<body>
		...
		<div id="show-student" class="content scaffold-show" role="main">
			...
			<ol class="property-list student">
				...
				<g:if test="${studentInstance?.full_studentname}">
				<li class="fieldcontain">
					<span id="full_studentname-label" class="property-label"><g:message code="student.full_studentname.label" default="Fullstudentname" /></span>
					
						<span class="property-value" aria-labelledby="full_studentname-label"><g:fieldValue bean="${studentInstance}" field="full_studentname"/></span>
				...
				<g:if test="${studentInstance?.student_register}">
				<li class="fieldcontain">
					<span id="student_register-label" class="property-label"><g:message code="student.student_register.label" default="Studentregister" /></span>
					
						<g:each in="${studentInstance.student_register}" var="s">
						<span class="property-value" aria-labelledby="student_register-label"><g:link controller="regEntry" action="show" id="${s.id}">${s?.encodeAsHTML()}</g:link></span>
						</g:each>
